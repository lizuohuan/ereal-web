...
<script>
    ...
    webApp.controller("distributionProportionCtr", function($scope,$http,$timeout){
        ...
        $scope.score = YZ.getUrlParam("score"); // 外部结项得分
        $scope.projectKList = null; //存放k值分配 和 耗时
        //获取外部项目 k值分配 和 耗时
        YZ.ajaxRequestData("get", false, YZ.ip + "/projectK/getKAndUser", {projectRecordId : $scope.projectRecordId, type : 1} , null , function(result) {
