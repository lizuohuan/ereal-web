...
<div class="admin-main">
    ...
    <fieldset class="layui-elem-field"></button>
        <legend>权限管理列表&nbsp;<i class="fa fa-refresh" aria-hidden="true"></i></legend></legend>
        <div class="layui-field-box layui-form">
            <blockquote class="layui-elem-quote">
                <button onclick="addData()" class="layui-btn layui-btn layui-btn-small layui-btn-normal"><i class="layui-icon">&#xe608;</i> 添加</button>
            </blockquote>
...
<script>
    ...
    function addData() {
        var index = layer.open({
            ...
            area: ['400px', '500px'],
            content: YZ.ip + "/page/jurisdiction/add"
        });
        layer.full(index);
    }
    ...
    function updateData (detail) {
        localStorage.setItem("jurisdiction", JSON.stringify(detail));
        var index = layer.open({
            type: 2,
            title: '修改权限',
            shadeClose: true,
            maxmin: true, //开启最大化最小化按钮
            area: ['400px', '500px'],
            content: YZ.ip + "/page/jurisdiction/edit"
        });
        layer.full(index);
    }
