...
<body>
    ...
    <form class="layui-form" action="" id="formData">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">是否是经理</label>
            <div class="layui-input-block">
                <input type="checkbox" name="level" lay-skin="switch" title="开关" lay-text="是|否">
            </div>
        </div>
    ...
    <script>
        layui.use(['form', 'layedit', 'laydate'], function() {
            ...
            form.on('submit(demo1)', function(data) {
                ...
                YZ.ajaxRequestData("post", false, YZ.ip + "/role/insert", data.field , null , function(result) {
