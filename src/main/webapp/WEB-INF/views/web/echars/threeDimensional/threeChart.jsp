...
<div class="admin-main">
                ...
                <form class="layui-form" action="" id="formData">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select id="type" name="type" lay-filter="dateType">
                                    <option value="0">统计团队文化工程得分</option>
                                    <option value="1">团队文化工程完成率</option>
                                    <option value="2">个人文化工程得分</option>
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
    ...
    <fieldset class="layui-elem-field"></button>
        <legend>文化工程统计表&nbsp;<i class="fa fa-refresh" aria-hidden="true"></i></legend></legend>
        <div class="layui-field-box layui-form">
...
<script>
    ...
    function passingParameters() {
        ...
        bindData(userId, date, dateType, companyId, departmentId, type,ccId);
        setTimeout(function () {layer.close(index);}, 600);
    }

    //默认查询登录人
    bindData(YZ.getUserInfo().id, new Date(), 0, 0, 0, 0,YZ.getUserInfo().companyId);
     ...
     * @return
     */
    function bindData (userId, date, dateType, companyId, departmentId, type,ccId) {
        var userKs = []; //个人K
        var userNames = []; //员工名字
        var arr = {};
        //查看公司
