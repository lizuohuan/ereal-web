...
<div class="admin-main">
    ...
    <fieldset class="layui-elem-field"></button>
        <legend>团队K总完成率统计表&nbsp;<i class="fa fa-refresh" aria-hidden="true"></i></legend></legend>
        <div class="layui-field-box layui-form">
...
<script>
    ...
    function passingParameters() {
        ...
        bindData(date, dateType, companyId, departmentId, 3);
        setTimeout(function () {layer.close(index);}, 600);
    }

    //默认查询登录人
    bindData(new Date(), 0, 0, YZ.getUserInfo().departmentId, 3);
