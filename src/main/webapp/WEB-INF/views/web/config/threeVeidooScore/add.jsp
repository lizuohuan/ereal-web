...
<div style="margin: 15px;">
    ...
    <form class="layui-form" action="" id="formData">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" name="score" lay-verify="required|isDouble" placeholder="请输入评分数" autocomplete="off" class="layui-input" maxlength="10">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="monthTime" lay-verify="required" placeholder="请选择时间" onfocus="WdatePicker({dateFmt:'yyyy-MM'})"  autocomplete="off" class="layui-input" readonly>
            </div>
        </div>
...
<script>
    ...
    layui.use(['form', 'layedit', 'laydate'], function() {
        ...
        form.on('select(departmentId)', function(data){
            queryUserByDepartment(0,"userId",1,null,Number(data.value),null);
//            getDepartmentIdUser(Number(data.value), 0);
        ...
        form.on('submit(demo1)', function(data) {
            ...
            data.field.type = 1; // 默认月
            console.log(data.field);
            YZ.ajaxRequestData("post", false, YZ.ip + "/threeVeidooScore/add", data.field , null , function(result) {
                if (result.flag == 0 && result.code == 200) {
                    layer.alert('添加成功.', {
