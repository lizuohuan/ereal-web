...
<div class="admin-main">
    ...
    <fieldset class="layui-elem-field"></button>
        <legend>第三维K团队评分列表&nbsp;<i class="fa fa-refresh" aria-hidden="true"></i></legend></legend>
        <div class="layui-field-box layui-form">
            <blockquote class="layui-elem-quote">
                <button onclick="addData()" class="layui-btn layui-btn layui-btn-small layui-btn-normal hide checkBtn_146"><i class="layui-icon">&#xe608;</i> 添加第三维K团队评分</button>
            </blockquote>
...
<script>
    ...
    function addData() {
        var index = layer.open({
            ...
            area: ['400px', '500px'],
            content: YZ.ip + "/page/config/threeVeidooKgScore/add"
        });
        layer.full(index);
    }
