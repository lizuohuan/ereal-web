...
<div style="margin: 15px;">
    ...
    <form class="layui-form" action="" id="formData" ng-controller="editSecondTargetConfigCtr" ng-cloak>
        ...
        <div class="layui-form-item layui-hide">
            ...
            <div class="layui-input-inline">
                <input type="number" value="{{secondTarget.targetNum}}" name="targetNum" lay-verify="" placeholder="请输入目标结项数" autocomplete="off" class="layui-input" maxlength="10">
            </div>
        </div>
...
<script>
    ...
    webApp.controller("editSecondTargetConfigCtr", function($scope,$http,$timeout){
        ...
        layui.use(['form', 'layedit', 'laydate'], function() {
            ...
            getAllDepartment($scope.secondTarget.departmentId);
