...
<div style="margin: 15px;">
    ...
    <form class="layui-form" action="" id="formData" ng-controller="editThreeVeidooKgCtr" ng-cloak>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="date" lay-verify="required" placeholder="请选择时间" value="{{ threeVeidooKgScore.startTime | date:'yyyy-MM'}}" onfocus="WdatePicker({dateFmt:'yyyy-MM'})"  autocomplete="off" class="layui-input" readonly>
            </div>
        </div>
