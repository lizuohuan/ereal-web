    ...
    <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box layui-form">
            <blockquote class="layui-elem-quote">
                <button onclick="addData()" class="layui-btn layui-btn-small layui-btn-normal hide checkBtn_152"><i class="layui-icon">&#xe64a;</i> 图片已生成去上传</button>
                <button onclick="generateImages(event)" class="layui-btn layui-btn-small hide checkBtn_153"><i class="layui-icon">&#xe64a;</i> 生成图片</button>
...
<script>
    ...
    var msg = localStorage.getItem("twoCompanyName") + "-" + localStorage.getItem("twoTimeName") + "度-" + YZ.getUrlParam("time");
    $("#condition").html(msg);
            ...
            "columnDefs": [
                ...
                },
                {
                    "render": function(data, type, row) {
                        ...
                        return "<button onclick='updateData(" + object + ")' class='updateBtn layui-btn layui-btn-small hide checkBtn_154'><i class='fa fa-list fa-edit'></i>&nbsp;修改</button>";
                    },
                    "targets": 4
                },
            ]
    ...
    function addData () {
        ...
        var index = layer.open({
            ...
            area: ['400px', '500px'],
            content: YZ.ip + "/page/banner/add?ids=" + ids.toString() + "&dimensionType=1&companyId=" + YZ.getUrlParam("companyId")
        });
        layer.full(index);
    }
    ...
    function updateData (object) {
        var index = layer.prompt({
            ...
            YZ.ajaxRequestData("post", false, YZ.ip + "/kStatistics/updateUserStatistics", arr , null , function(result) {
                if (result.flag == 0 && result.code == 200) {
