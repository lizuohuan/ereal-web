...
<body>
    <div style="margin: 15px;">
        ...
        <form class="layui-form" action="" id="formData">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">选择月份<span class="font-red">*</span></label>
                <div class="layui-input-inline">
                    <input class="layui-input" name="month" lay-verify="required" placeholder="选择月份" onfocus="WdatePicker({dateFmt:'yyyy-MM'})" readonly>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">发布类型<span class="font-red">*</span></label>
                <div class="layui-input-inline">
    ...
    <script>
        ...
        layui.use(['layer', 'form', 'layedit', 'laydate', 'element'], function() {
            ...
            form.on('submit(demo1)', function(data) {
                data.field.month = new Date(data.field.month);
                console.log(data);
                YZ.ajaxRequestData("post", false, YZ.ip + "/spiritAwards/addSpiritAwards", data.field , null , function(result) {
